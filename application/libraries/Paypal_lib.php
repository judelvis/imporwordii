...
class paypal_lib {
	...
	function paypal_auto_form() 
	{
		...
		$this->button('Click aqui si no es redirigido automaticamente...');
		...
		echo '<p style="text-align:center;">Por favor espere, su orden esta siendo procesada y enviada a paypal website.</p>' . "\n";
